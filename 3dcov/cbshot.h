...
public :
   ...
   // static void calculate_ICP_COV(pcl::PointCloud<pcl::PointXYZ>& data_pi, pcl::PointCloud<pcl::PointXYZ>& model_qi, Eigen::Matrix4f & transform, Eigen::MatrixXd & ICP_COV);
    
    static void calculate_cov(pcl::PointCloud<pcl::PointXYZ>& cloud_in, pcl::PointCloud<pcl::PointXYZ>& cloud_out, Eigen::Matrix4f & iG_transf, Eigen::Matrix4f& f_transform, Eigen::MatrixXd & iG_cov);
    static void calculate_ransac(pcl::PointCloud<pcl::PointXYZ>& cloud_in, pcl::PointCloud<pcl::PointXYZ>& cloud_out, Eigen::Matrix4f & iG_transf);
